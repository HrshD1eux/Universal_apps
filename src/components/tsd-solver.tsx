...
type TSDMode = 'relative' | 'boats' | 'trains';
...
export default function TSDSolver() {
  ...
  const results = useMemo(() => {
    ...
    return { relSpeed, downstream, upstream, timeToCross };
  }, [v1, v2, direction, boatSpeed, streamSpeed, trainLen, platformLen, trainSpeed]);
